...
# get the data
    url = "{root_url}/{endpoint}?source={base}&api_key={api_key}&currencies={symbols}&start_date={observation_start}&end_date={observation_end}"         .format(root_url="https://api.apilayer.com",
